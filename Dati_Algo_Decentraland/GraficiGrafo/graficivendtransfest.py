...
#GRAFICO  DIFFERENZA VENDITE TRASFERIMENTI ACCOUNT ESTATE
with open('../Dati/Dati_Grafi/weightdegest.json','r') as file:
...
plt.title("Grafico delle vendite Estate")
...
plt.savefig("Risultati/vendest.png")
#plt.show()